...
ARTG_btm1_rf = ARTG_btm1.TmStamp > datetime(2023,01,01); % Change conditions
ARTG_btm2_rf = ARTG_btm2.TmStamp > datetime(2023,01,01); % Change conditions
ARTG_sfc_rf = ARTG_sfc.TmStamp > datetime(2023,01,01); % Change conditions
